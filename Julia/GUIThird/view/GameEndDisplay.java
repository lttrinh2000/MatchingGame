...
public class GameEndDisplay
{
    ...
    public GameEndDisplay(int timeTaken, int numberMoves, String difficulty)
    {
        ...
        prevName = HighScore.getHighScoreName(difficulty);
        prevHigh = HighScore.getHighScoreValue(difficulty);
    }
        ...
        if (userMoves < prevHigh)
        {
            ...
            submitButton.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent e)
                {
                    ...
                    HighScore.saveHighScore(userName, String.valueOf(moves), difficulty);
                }
            });
        }
