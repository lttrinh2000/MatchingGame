...
public class TerminalInput
{
    ...
    public void beginGame(Deck d)
    {
		 ...
		 * NEW Change below
		**/
		pos = score.position(userInput);
                currentScore = score.getCurrentScore(pos);
		System.out.println("The current high score is: "+ currentScore);
                System.out.println("This score was set by: " + score.getHighScore(pos));
    }
	...
	public void endGame(int moves)
	{
		...
		if(moves < currentScore) 
		{
			 ...
			 * NEW Change below
			**/
			score.saveHighScore(name, String.valueOf(moves),pos);
